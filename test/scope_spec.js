...
describe('Scope', function() {
    ...
    it('can be constructured and used as an object', function() {
        var scope = new Scope();
        scope.aProperty = 1;
    ...
    describe('$digest', function() {
        ...
        it('calls thw listener function when the watched value changes', function() {
            scope.someValue = 'a';
            scope.counter = 0;
            scope.$watch(
        ...
        it('cathces exceptions in watch functions and continues', function() {
            scope.aValue = 'abc';
            scope.counter = 0;
    ...
    describe('$evalAsync', function() {
        ...
        it('executes given function lates in the same cycle', function() {
            scope.aValue = [1, 2, 3];
    ...
    describe('$watchGroup', function() {
        ...
        it('uses different arrays for old and new values on susequent runs', function() {
            var gotNewValues, gotOldValues;
        ...
        it('can be defegistered', function() {
            var counter = 0;
